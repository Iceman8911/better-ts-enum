...
export interface _DefaultBasicEnumClassConfig
	extends _BasicEnumClassConfig, _DefaultSharedEnumClassConfig {
...
export interface _BasicEnumClassBuilderConfig extends _SharedEnumClassBuilderConfig {}

export interface _DefaultBasicEnumClassBuilderConfig
	extends _BasicEnumClassBuilderConfig, _DefaultSharedEnumClassBuilderConfig {
	readonly freeze: true;
	readonly nominal: "";
